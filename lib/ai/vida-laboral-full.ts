...
function parseJsonToVidaLaboral(
  ...
  return mergeVidaLaboral(base, {
    ...
    resumen: {
      ...
      diasAltaTotal: num(res.diasAltaTotal),
      diasPluriempleo: num(res.diasPluriempleo),
    },
    periodosContrato,
    periodosAutonomo,
    prestacionesDesempleo,
...
async function extractLocalFallbackFromPdf(
  ...
  const informe = mergeVidaLaboral(emptyVidaLaboral(documentType), {
    ...
    resumen: {
      ...
      diasRestantes: parsed.resumen.diasRestantes ?? null,
      ...
      diasAltaTotal: parsed.resumen.diasAltaTotal ?? null,
      diasPluriempleo: parsed.resumen.diasPluriempleo ?? null,
    },
