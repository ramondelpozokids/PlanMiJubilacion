-- Ejecutar en Supabase SQL Editor si npm run db:push no conecta
-- Migraciones 007 + 008 combinadas

-- 007: escenario vital por consulta
...
-- 008: billing + international pricing
